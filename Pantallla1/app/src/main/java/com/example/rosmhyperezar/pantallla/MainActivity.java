package com.example.rosmhyperezar.pantallla;
...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    ArrayAdapter <String> University,pregrado,Tiempo1,Tiempo2;

    String [] universidad = {"Adventista","Eafit"};
    String [] carrera = {"IngeneriadeSistemas","Contaduria"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Tiempo1= new ArrayAdapter<String>(this, android.R.layout.simple_spinner_dropdown_item,duracion);
            ...
            case R.id.spinner2:
                switch (p) {
                    case 0:
                        ...
                        if (valor1.equals("IngeneriadeSistemas") && (valor.equals("Eafit"))) {
                            spinner3.setAdapter(Tiempo1);
                            break;
                        }
